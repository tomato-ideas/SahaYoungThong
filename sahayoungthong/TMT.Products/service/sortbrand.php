...
if($numrow > 0){
	while($result = mysql_fetch_array($query)){
		echo "<tr>";
			echo "<td style='text-align:center;'>".$result['brand_id']."</td>";
			if($result['brand_picture'] == '//' || $result['brand_picture'] == ''){
			    echo "<td class='imgThb2All'></td>";
		    }else{
			    echo "<td class='imgThb2All'><img src='../wp-content/uploads/".$result['brand_picture']."'></td>";
		    }
